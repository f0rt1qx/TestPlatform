...
<div class="auth-wrapper">
  <div class="auth-card">
    <div class="auth-logo">
      <a href="index.php" style="text-decoration:none;"><h1 style="flex-direction:column;gap:10px;"><img src="src/logo.png" alt="Sapienta logo" width="72" height="72" style="width:72px;height:72px;object-fit:contain;flex-shrink:0;filter:none!important;"> <span>Sapienta</span></h1></a>

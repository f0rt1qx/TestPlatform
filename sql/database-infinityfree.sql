-- ============================================================
-- Test Platform Database — InfinityFree Edition
-- Import via phpMyAdmin (уже выбранная база if0_41654195_testplatformdb)
-- ============================================================
...
('admin', 'admin@sapienta.local', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uhGf6YSfNv/M', 'admin', 'Администратор', 'Системы', 1);

-- Student user (password: Student123!)
INSERT INTO `users` (`username`, `email`, `password_hash`, `role`, `first_name`, `last_name`, `email_verified`) VALUES
('student1', 'student@sapienta.local', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uhGf6YSfNv/M', 'student', 'Иван', 'Иванов', 1);
